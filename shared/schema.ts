...
export const VOTE_OPTIONS = [
  { id: 1, name: "Я принимаю решение каждый день благодарить Вс-вышнего за хорошие вещи и читать 100-й псалом Теилим", icon: "Guitar" },
  { id: 2, name: "Я принимаю решение каждый день читать свой личный псалом и псалом своих детей по возрасту", icon: "Music2" },
  { id: 3, name: "Я принимаю решение соблюдать 4 заповеди праздника Пурим: слушание Свитка Эстер, праздничный пир, съестные подарки друзьям и подарки бедным", icon: "Music3" },
