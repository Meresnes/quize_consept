...
export const VOTE_OPTIONS = [
  ...
  { id: 3, name: "Я принимаю решение соблюдать 4 заповеди праздника Пурим: чтения Свитка Эстер, праздничный пир, съестные подарки друзьям и подарки бедным", icon: "Music3" },
