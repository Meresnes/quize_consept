...
export const VOTE_OPTIONS = [
  ...
  { id: 2, name: "Каждый день благодарить за 3 хорошие вещи, которые произошли со мной в течение дня и читать 100-й псалом Теилим как благодарность за все и ощущать чувство признательности.", icon: "Guitar" },
  { id: 3, name: "Каждый день читать свой личный псалом, соответсвующий возрасту и личный псалом своих детей.", icon: "Music2" },
